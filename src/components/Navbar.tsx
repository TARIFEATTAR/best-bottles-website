...
export default function Navbar({ onCartOpen, variant = "home", initialSearchValue }: NavbarProps) {
    const router = useRouter();
    const { open: openGrace, isOpen: graceActive } = useGrace();
        ...
        >
            ...
            <div className="max-w-[1440px] mx-auto px-6 h-[72px] flex items-center justify-between gap-6">
                ...
                <div className="flex items-center space-x-10 shrink-0">
                    <Link
                        href="/"
                        className="font-serif text-2xl font-medium tracking-tight text-obsidian"
                    >
                        BEST BOTTLES
                    </Link>
                ...
                {/* Right: Grace Trigger + Account + Cart */}
                <div className="flex items-center space-x-2 shrink-0">

                    {/* Grace Conversation Trigger */}
                    <button
                        onClick={openGrace}
                    ...
                    <button
                        aria-label="Account"
                        className="p-2 hover:text-muted-gold transition-colors"
                    >
