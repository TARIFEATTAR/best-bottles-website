...
console.log("Reclassifying plastic bottle products...\n");
...
while (hasMore) {
    const result = await client.mutation(api.migrations.reclassifyPlasticBottleProducts, {
        cursor,
        batchSize: 250,
    });
...
console.log(`\n✅ Reclassification complete. Updated ${totalUpdated} products (scanned ${totalScanned}).`);
