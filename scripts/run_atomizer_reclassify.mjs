...
console.log("Reclassifying atomizer products...\n");
...
while (hasMore) {
    const result = await client.mutation(api.migrations.reclassifyAtomizerProducts, {
        cursor,
        batchSize: 250,
    });
...
console.log(`\n✅ Atomizer reclassification complete. Updated ${totalUpdated} products (scanned ${totalScanned}).`);
